...
Task: T-0014 · socket API v1 — DONE + PUSHED (3696258; api 4/4 + slices green, evidence in .loop/evidence/T-0014/)
Where you are: 16 of 22 tasks done and pushed (Phase 1 underway); remote == local
Next step: next turn picks T-0015 (TUI), T-0016 (themes), or T-0017 (adapters); Phase-0 gate needs-human flag still stands
Open workers: (none)
Known broken: (none) · Parked: (none)
Findings: old JSONL clients hang (not error) against frames — handshake timeout makes it loud; cutover deleted JSONL everywhere (one framing)
